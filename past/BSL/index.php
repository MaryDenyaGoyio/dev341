...
$PlayerStatsQuery = "SELECT *, 
                        ...
                        Players.Name
                    FROM PlayerStats
                        JOIN Players ON Players.PlayerID = PlayerStats.PlayerID";
...
<head>
    ...
    <title> BCK Official 21~23 </title> <!-- 브라우져 탭 제목 -->
    <meta property="og:title" content="BCK Official 21~23"> <!-- 링크 공유시 페이지 이름 -->
